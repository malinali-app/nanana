...
mixin _$FormErrorTranscriptionCreate on FormErrorTranscriptionCreateAbs, Store {
  ...
  late final _$languageErrorAtom = Atom(
      name: 'FormErrorTranscriptionCreateAbs.languageError', context: context);

  @override
  String? get languageError {
    _$languageErrorAtom.reportRead();
    return super.languageError;
  }

  @override
  set languageError(String? value) {
    _$languageErrorAtom.reportWrite(value, super.languageError, () {
      super.languageError = value;
    });
  }
